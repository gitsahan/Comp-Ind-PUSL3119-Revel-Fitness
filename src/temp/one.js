        ...
        return(
            <div className="overflow-x-hidden">
                ...
                <div className="flex flex-col justify-center items-center bg-gradient-to-r from-cyan-950 to-gray-900">
                    ...
                    <StripeCheckout name= "Monthly Subscription Payment" currency="lkr" amount="2100000" token={onToken} stripeKey="pk_test_51N8LF6A0mKgCHMZDAHANYKWpzubifKK7OrQj40CyE73wXAxHbTXgd66nnu1pRpIyIlDRirIYEd8tWseH65ENbTNb00RNY3ZMIg" className="bg-gray-900"/>
