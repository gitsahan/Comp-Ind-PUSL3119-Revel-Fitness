...
const AdminLogin = () => {
    ...
    return(
        <div>
        <div className="py-12 flex flex-col items-center bg-gradient-to-r from-cyan-950 to-sky-800">
            ...
            <form onSubmit={SignIn} className="flex flex-col">
                ...
                <div className="flex flex-col items-center">
                    <p className="text-xl text-amber-500 font-bold font-headFont uppercase mt-5">Admin Login</p>
        ...
        <div className="h-10 w-full bg-gradient-to-r from-cyan-950 to-sky-800"/> <Footer/>
        </div>            
    );
};
